...
const PACKAGE = process.env.TRACK_PACKAGE || 'chartsheet'
const REPO = process.env.TRACK_REPO || 'ritusmoikaushik/chartsheet'
...
const get = url => new Promise(resolve => {
  https.get(url, { headers: { 'user-agent': 'chartsheet-tracker' } }, res => {
    let body = ''
